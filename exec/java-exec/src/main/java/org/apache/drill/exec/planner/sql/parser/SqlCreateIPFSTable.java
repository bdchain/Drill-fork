...
import org.apache.drill.exec.planner.sql.handlers.CreateIPFSTableHandler;
...
public class SqlCreateIPFSTable extends DrillSqlCall {
  public static final SqlSpecialOperator OPERATOR = new SqlSpecialOperator("CREATE_IPFSTABLE", SqlKind.OTHER) {
    @Override
    public SqlCall createCall(SqlLiteral functionQualifier, SqlParserPos pos, SqlNode... operands) {
      Preconditions.checkArgument(operands.length == 6, "SqlCreateIPFSTable.createCall() has to get 6 operands!");
      return new SqlCreateIPFSTable(pos,
  ...
  public SqlCreateIPFSTable(SqlParserPos pos,
  ...
  public AbstractSqlHandler getSqlHandler(SqlHandlerConfig config, Pointer<String> textPlan) {
    ...
    return new CreateIPFSTableHandler(config, textPlan);
  }
